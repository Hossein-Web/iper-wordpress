        ...
        <div class="container">
            ...
            if ($persian_news_title) {
                ...
                <div class="bourse-title">
                    ...
                    <a class="bourse-read-more" href="#"><?php _e('مشاهده بیشتر', 'persian_bourse'); ?><i
                            ...
                            <div class="comments__wrapper">
                                ...
                                <ul>
                                    ...
                                    <li class="d-flex align-items-center">
                                        ...
                                        <div class="comment-content">
                                            <p>پیمان طباطبایی</p>
                                            <p>سلام . وقت بخیر . لطفا بفرمایید چگونه می توان فیلتری نوشت
                                                تا...</p>
                                    ...
                                    <li class="d-flex align-items-center">
                                        ...
                                        <div class="comment-content">
                                            <p>رضا اکبری</p>
                                            <p> با سلام این وظیفه ماست که هر هفته 40 نماد منتخب سایت را
                                                اپدی...</p>
                                            <a href="#" class="view-more">مشاهده در مطلب</a>
                                        </div>
                                    </li>
